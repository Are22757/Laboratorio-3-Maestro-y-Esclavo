#define F_CPU 16000000UL // Define la frecuencia de la CPU para cálculos de tiempo
...
// Variables globales
volatile uint8_t valorSpi1, valorSpi2; // Valores leídos desde SPI
...
// Envía los valores leídos del SPI a través de UART
...
// Realiza la lectura de datos desde el ADC a través de SPI
void lecturaADC() {
...
// Función de manejo de interrupciones de comunicación UART
void IntCont() {
	if (UART_available()) {
...
// Pide un número al usuario y lo muestra en los puertos
void contNUm() {
